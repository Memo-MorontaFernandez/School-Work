<?php  
	...
	if (isset($_POST['register-btn'])) {
		...
		if ($username || $email) {
			$check_sql = "SELECT u_id FROM a1_finalProjectUsers 
		...
		if ($pass_go == true) {
			...
			$insert_sql = "INSERT INTO a1_finalProjectUsers (first_name, last_name, email, user_name, password) VALUES ('$first_name', '$last_name', '$email', '$username', '$hash')";
