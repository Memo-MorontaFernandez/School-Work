...
<div>
	...
	<?php  
		$list_sql = "SELECT ad_id, title, ad, price, image_name, date_posted, user_name, a1_users.u_id, itemsold_yn, deleted_yn FROM a1_forSale INNER JOIN a1_users ON a1_forSale.u_id = a1_users.u_id WHERE a1_users.u_id = ".$_SESSION['user_id'];;
			...
			<?php while ($row = $list_result->fetch_assoc()): ?>
				...
				<div>
					...
					<?php if ($_SESSION['user_id'] == $u_id):?>
						...
						<?php else: ?>
							<a href="mark-job-unfilled.php?id=<?php echo $ad_id; ?>">Available</a>
						<?php endif ?>
