...
<div>
	...
	<?php  
		$list_sql = "SELECT ad_id, title, ad, date_posted, user_name, a1_users.u_id, job_filled_yn, deleted_yn FROM a1_jobs INNER JOIN a1_users ON a1_jobs.u_id = a1_users.u_id WHERE deleted_yn = 'N' AND job_filled_yn = 'N' $search_part ORDER BY $orderBy $order $limit_string ";
				...
				<div>
					...
					<?php if ($_SESSION['user_id'] == $u_id):?>
						...
						<?php if ($job_filled_yn == 'N'): ?>
							<a href="mark-job-filled.php?id=<?php echo $ad_id; ?>">Mark Filled</a>
						<?php endif ?>
